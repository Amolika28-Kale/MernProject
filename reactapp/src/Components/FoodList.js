        ...
        <div key={x.food_id} className="card">
          ...
          <div className="card-body">
            ...
            <h6 className="card-text">Quantity: {x.food_quantity}
              <select className='m-2 h-100 bg-warning ' value={selectedQuantities[x.food_id] || 1}
          ...
          <div className="card-footer">
            <button className="btn btn-warning ms-2"onClick={() => handleAddToCart(x)}> Add To Cart</button>
          </div>
        </div>
      ))}
    </div>
